...
- [Philosophy](/docs/reference/philosophy) - Why AGIT exists
- [MCP Integration](/docs/guides/mcp-integration) - Protocol details
- [Git Resilience](/docs/guides/git-resilience) - Handling complex Git workflows
