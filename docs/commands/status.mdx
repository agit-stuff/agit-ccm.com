...
During these states, `agit record`, `agit add`, and `agit commit` are blocked. See [Git Resilience](/docs/guides/git-resilience) for details.
...
- [agit add](/docs/commands/add) - Stage files and freeze context
- [agit record](/docs/commands/record) - Manually record thoughts
- [agit commit](/docs/commands/commit) - Create commit with staged context
- [Git Resilience](/docs/guides/git-resilience) - How AGIT handles conflicts
