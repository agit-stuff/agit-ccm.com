...
**Solution**: Complete the merge/rebase before committing to AGIT. See [Git Resilience](/docs/guides/git-resilience).
...
- [agit status](/docs/commands/status) - Check staging area before committing
- [agit log](/docs/commands/log) - View commit history
- [agit show](/docs/commands/show) - View full commit details
